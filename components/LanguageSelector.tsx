...
import { useLanguage, SUPPORTED_LANGUAGES } from '@/components/LanguageProvider';
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <button
        ...
        className="flex items-center gap-2 px-3 py-1.5 md:px-4 md:py-2 bg-gray-50 border border-gray-200 rounded-full hover:bg-gray-100 hover:border-gray-300 transition-all font-medium text-sm text-gray-700 shadow-sm"
      >
